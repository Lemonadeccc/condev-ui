import { AnimatePresence, domAnimation, LazyMotion, m, useAnimate } from 'framer-motion'
import { useState } from 'react'

import { IconCodeLine } from '@condev-ui/ui';
  ...
  return (
    <div className='pt-3'>
      <div className="flex justify-end mb-3">
        {cssCode && (
          <div className={cn('flex items-center text-xs text-color-400 hover:bg-color-100 px-2 py-1 rounded-md cursor-pointer border border-solid border-color mr-3', {
        ...
        <div className={cn('flex items-center text-xs text-color-400 hover:bg-color-100 px-2 py-1 rounded-md cursor-pointer border border-solid border-color', {
